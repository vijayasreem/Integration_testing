...
public class LoanApplicationController {
    ...
    @GetMapping("/customer/{customerId}/submission-date-range")
    public List<LoanApplication> findByCustomerIdAndSubmissionDateRange(@PathVariable Long customerId, @RequestParam("startDate") LocalDate startDate, @RequestParam("endDate") LocalDate endDate) {
        return loanApplicationService.findByCustomerIdAndSubmissionDateRange(customerId, startDate, endDate);
    }
}